...
const FormLayout = () => {
  const [dataSource, setDataSource] = useState<DataType[]>([
    {
      ...
      id: "qnwmkv5704blag6r",
      label: "File so 1",
      sampleFile: "https://www.pinterest.com/pin/70437487285872/",
      isMandatory: true,
      position: "1",
    },
  ]);
  ...
  const defaultColumns: (ColumnTypes[number] & {
    ...
    },
    {
      ...
      render: (_, record) => {
        const defaultFileList = record.sampleFile
          ? [
              {
                uid: "-1",
                name: record.sampleFile,
                status: "done",
                url: `https://www.pinterest.com/pin/70437487285872/`,
              },
            ]
          : [];
        return (
